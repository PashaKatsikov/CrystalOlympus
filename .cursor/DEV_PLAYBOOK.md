...
- The OneLink host is hardcoded in the manifest's App Link intent-filter. Point
  it at this project's `*.onelink.me` subdomain and register the signing SHA-256
  fingerprints on the OneLink template, or verification fails.
